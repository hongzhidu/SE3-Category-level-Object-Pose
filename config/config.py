...
flags.DEFINE_string('dataset_dir', '/media/hongzhidu/data/6DoF/Datasets/mydata', 'path to the dataset')
flags.DEFINE_string('detection_dir', '/media/hongzhidu/data/6DoF/Datasets/CAMERA/data/segmentation_results', 'path to detection results')
...
# pose network
flags.DEFINE_integer('feat_c_R', 1266, 'input channel of rotation')
flags.DEFINE_integer('R_c', 4, 'output channel of rotation, here confidence(1)+ rot(3)')
flags.DEFINE_integer('feat_c_ts', 1269, 'input channel of translation and size')
...
flags.DEFINE_string('model_save', 'checkpoints', 'path to save checkpoint')
# resume
